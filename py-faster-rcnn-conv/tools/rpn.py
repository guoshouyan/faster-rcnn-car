...
from rpn.generate import imdb_proposals,im_proposals,_get_image_blob
import cPickle
import caffe
import argparse
import pprint
...
if __name__ == '__main__':
    ...
    '''
    rpn_file = os.path.join('/home/shouyang/py-faster-rcnn-conv/tools/output', net.name + '_rpn_proposals.pkl')
